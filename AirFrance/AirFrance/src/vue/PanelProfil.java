...
public class PanelProfil extends PanelPrincipal implements ActionListener {
    ...
    private void updateInfosText() {
        ...
        txtInfos.setForeground(Color.WHITE);
        txtInfos.setFont(new Font("Arial", Font.BOLD, 14));
        txtInfos.setEditable(false);
        txtInfos.setOpaque(false);
        txtInfos.setBounds(0, 0, getWidth(), getHeight());
        txtInfos.setAlignmentX(CENTER_ALIGNMENT);
        txtInfos.setAlignmentY(CENTER_ALIGNMENT);
    }
}
